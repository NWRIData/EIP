...
os.makedirs("data/dropbox_data/", exist_ok=True)
local_path_eligiblitytable = os.path.join("data/dropbox_data/", latest.name)


dbx.files_download_to_file(local_path_eligiblitytable, latest.path_display)

print(f"Downloaded {latest.name} to report folder")
